...
const SendReminderModal: React.FC<SendReminderModalProps> = ({ isOpen, onClose, customer, pharmacy }) => {
    ...
    const whatsappMessage = encodeURIComponent(
        `Hello ${customer.name},\n\nThis is a friendly reminder from ${pharmacy.pharmacyName} regarding your outstanding balance of ₹${balance.toFixed(2)}. \nPlease feel free to contact us if you have any questions.\n\nThank you!`
    );
    // Remove non-digit characters for the phone number
